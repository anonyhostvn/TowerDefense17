...
public class DBarrelTowerDrawer implements DrawerEntity {
    private static final Image base = new Image(RoadDrawer.class.getResourceAsStream("/Retina/towerDefense_tile181.png"));
    private static final Image gun = new Image(RoadDrawer.class.getResourceAsStream("/Retina/towerDefense_tile250.png"));
