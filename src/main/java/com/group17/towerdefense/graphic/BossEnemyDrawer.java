...
public class BossEnemyDrawer implements DrawerEntity {
    private static Image enemyImage = new Image(Mountain.class.getResourceAsStream("/Retina/towerDefense_boss.png"));
