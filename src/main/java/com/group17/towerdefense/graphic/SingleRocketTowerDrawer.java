...
public class SingleRocketTowerDrawer implements DrawerEntity {
    private static final Image base = new Image(RoadDrawer.class.getResourceAsStream("/Retina/towerDefense_tile229.png"));
    private static final Image rocket = new Image(RoadDrawer.class.getResourceAsStream("/Retina/towerDefense_tile252.png"));
