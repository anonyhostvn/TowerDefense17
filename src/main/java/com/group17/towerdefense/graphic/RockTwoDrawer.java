...
public class RockTwoDrawer implements DrawerEntity {
    private static final Image rockImage = new Image(RockTwoDrawer.class.getResourceAsStream("/Retina/towerDefense_tile137.png"));
