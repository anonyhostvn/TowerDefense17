...
public class Bullet_1_Drawer implements DrawerEntity{
    private static final Image bulletImage = new Image(RoadDrawer.class.getResourceAsStream("/Retina/towerDefense_tile275.png"));
