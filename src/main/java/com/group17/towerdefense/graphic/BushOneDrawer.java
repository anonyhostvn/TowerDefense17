...
public class BushOneDrawer implements DrawerEntity {
    private static final Image rockImage = new Image(BushOneDrawer.class.getResourceAsStream("/Retina/towerDefense_tile134.png"));
